...
Arduino.S4Afunctions =
    ...
    + '  }\n\n'
    + '  void qmotor(int port, boolean booleanValue, int value) {\n'
    + '    int pin, qpin;\n'
    + '      if(port=="M1"){pin=4; qpin=5;}\n'
    + '      if(port=="M2"){pin=7; qpin=6;}\n'
    + '       pinMode(pin, OUTPUT);\n'
    + '       pinMode(qpin, OUTPUT);\n'
    ...
    + '  }\n\n'
    + '  void qanalogWrite(int port, int value) {\n'
    + '    int pin;\n'
    + '      if(port==1){pin=0;}\n'
    + '      if(port==2){pin=1;}\n'
    + '      if(port==3){pin=2;}\n'
    ...
    + '  }\n\n'
    + '  void qservowrite(int port, int min, int max, int value){\n'
    + '      int i, val, pin;\n'  
    + '      if(port==1){pin=3;}\n'
    + '      if(port==2){pin=9;}\n'
    + '      if(port==3){pin=10;}\n'
