...
Arduino.transpile = function (body, hatBlocks) {
    ...
    + '#include <Servo.h>\n'
    + 'boolean S4Apins[TOTAL_PINS];\n' //digitalPins array defintion. Output pins will change their value to 1
    ...
    return this.headerMessage + header + body + broadcasts + this.S4Afunctions;
};
...
Arduino.S4Afunctions =
    ...
    + ' * ============================================\n'
    + ' *\n'
    + ' * S4Afunctions implement Snap4Arduino operation\n'
    + ' * in Arduino skectches.\n'
    + ' *\n'
    + ' * Bellow there are S4Amath, S4AdigitalWrite,\n'
    + ' * S4AanalogWrite, S4AdigitalRead, \n'
    + ' * S4AanalogRead and S4AservoWrite functions.\n'
    + ' *\n'
    + ' * These don\'t need any configuration (like pinMode).\n'
    + ' * You can use them directly in the sketch.\n'
    + ' */\n\n'
    + '/* ==================================\n'
    + ' *        S4Amath function\n'
    + ' * ==================================*/\n'
    + 'int S4Amath(char op,int num) {\n'
    + '  int result = 0;\n'
    + '  switch(op){\n'
    + '    case \'abs\':\n'
    + '      result = abs(num);\n'
    ...
    + '}\n\n'
    + '/* ==================================\n'
    + ' *        S4AdigitalWrite function\n'
    + ' * ==================================*/\n'
    + 'void S4AdigitalWrite(int pin, boolean level){\n'
    + '  if (!S4Apins[pin]){\n'
    + '    pinMode(pin,OUTPUT);\n'
    + '    S4Apins[pin] = 1;\n'
    + '  }\n'
    ...
    + '}\n\n'
    + '/* ==================================\n'
    + ' *        S4AanalogWrite function\n'
    + ' * ==================================*/\n'
    + 'void S4AanalogWrite(int pin, int value){\n'
    + '  if (!S4Apins[pin]){\n'
    + '    pinMode(pin,OUTPUT);\n'
    + '    S4Apins[pin] = 1;\n'
    + '  }\n'
    ...
    + '}\n\n'
    + '/* ==================================\n'
    + ' *        S4AdigitalRead function\n'
    + ' * ==================================*/\n'
    + 'boolean S4AdigitalRead(int pin){\n'
    + '  if (S4Apins[pin]){\n'
    + '    pinMode(pin,INPUT);\n'
    + '    S4Apins[pin] = 0;\n'
    + '  }\n'
    ...
    + '}\n\n'
    + '/* ==================================\n'
    + ' *        S4AanalogRead function\n'
    + ' * ==================================*/\n'
    + 'int S4AanalogRead(int pin){\n'
    + '  if (S4Apins[pin]){\n'
    + '    pinMode(pin,INPUT);\n'
    + '    S4Apins[pin] = 0;\n'
    + '  }\n'
    ...
    + '}\n\n'
    + '/* ==================================\n'
    + ' *        S4AservoWrite function\n'
    + ' * ==================================*/\n'
    + 'void S4AservoWrite(int pin, int value){\n'
    + '  if (value == -1) {\n'
