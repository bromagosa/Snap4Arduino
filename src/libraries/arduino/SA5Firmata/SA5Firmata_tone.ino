/*
  SA5Firmata_tone version 5 (is the "tone" version, not supporting IR features but with the full tone function)
  Pins 2 and 5 are marked as SHIFT mode
  October 2018
    ...
    case CAPABILITY_QUERY:
      ...
      for (byte pin = 0; pin < TOTAL_PINS; pin++) {
        if (IS_PIN_DIGITAL(pin)) {
          ...
          Firmata.write(1);
//////////////////////////////////////////////////
//SA5_tone version 5. Marking digital pins 2 and 5 
      if (pin == 2 || pin == 5) {
...
//
    case 0xCA: //ping command
      ...
      break;
/*
// IR functions only documented, not used here
//
//IR receiver
//
