...
var SerialPort = require('./serialport.js').SerialPort,
...
SYSEX_RESPONSE[QUERY_FIRMWARE] = function(board) {
    ...
    board.firmware.name = bops.to(bops.from(firmwareBuf));
...
SYSEX_RESPONSE[STRING_DATA] = function(board) {
    board.emit('string', bops.to(bops.from(board.currentBuffer.slice(2, -1))));
};
/**
